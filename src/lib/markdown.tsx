...
function PreWithTools(props: React.HTMLAttributes<HTMLPreElement> & { children?: React.ReactNode }) {
    ...
    <div className="markdown">
      <ReactMarkdown
        ...
        rehypePlugins={[
          rehypeKatex,
          rehypeSlug,
          [rehypeAutolinkHeadings as any, { behavior: "wrap", properties: { className: "heading-anchor" } }],
        ]}
        components={{
