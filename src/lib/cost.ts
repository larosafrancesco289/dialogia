...
export function computeCost(opts: {
  ...
  const pCost = promptRate != null && promptTokens != null ? (promptRate / 1_000_000) * promptTokens : 0;
  const cCost = completionRate != null && completionTokens != null ? (completionRate / 1_000_000) * completionTokens : 0;
