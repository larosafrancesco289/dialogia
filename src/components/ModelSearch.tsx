...
export const ModelSearch = forwardRef<ModelSearchHandle, ModelSearchProps>(function ModelSearch(
  {
    onSelect,
    selectedIds,
  ...
  const renderCapabilities = (result: ModelSearchResult) => {
    ...
    if (result.capabilities.zdr)
      items.push({ icon: <ShieldCheckIcon className={ICON_SIZE} />, label: 'Zero Data Retention' });
