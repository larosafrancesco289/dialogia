...
export function DeepResearchTimeline({ trace }: Props) {
  ...
  return (
    <div className="relative ml-3 pl-6 border-l-2 border-border/40 space-y-8 my-5">
      {trace.map((item, idx) => (
  ...
  if (type === 'thought') {
    return (
      <div className="relative group">
        <div className="absolute -left-[31px] top-1.5 w-4 h-4 rounded-full bg-surface border-2 border-border/60 group-hover:border-accent/50 transition-colors" />
  ...
  if (type === 'search') {
    ...
    return (
      <div className="relative">
        <div className="absolute -left-[33px] top-0.5 w-6 h-6 rounded-full bg-surface flex items-center justify-center ring-4 ring-surface">
