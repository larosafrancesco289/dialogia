...
- Evidence is what they did on their own. \`helped\` is about the step in the answer you are recording: mark it when your message just before did that step for them on this very problem (named the operation to use, gave its first step, pointed at the part to fix, or put the answer in the question or its choices), or they are repeating your correction of this same problem back to you. It shows little.
- A fresh problem is the test of what you taught, not help with it. When your message corrected or explained something and then posed a new case, their answer to the new case is their own work, even though the rule is fresh in their mind: not \`helped\`. Asking what they would do poses; telling them what to do helps. You corrected their 1/3 + 1/4 and asked "now 2/5 + 1/10?", and they rewrote both over 10 and got 5/10: their own work. You wrote "rewrite 2/5 over 10 first; what is it?" and they said 4/10: helped.
